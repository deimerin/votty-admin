...
const ballotURL = process.env.REACT_API_FIREBASE_DATABASE_BALLOT
const verfURL = process.env.REACT_API_FIREBASE_DATABASE_VERF
const votURL = process.env.REACT_API_FIREBASE_DATABASE_VOT
const candURL = process.env.REACT_API_FIREBASE_DATABASE_CAND
